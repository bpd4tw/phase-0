...
//I came across a bit of trouble with test 13. I realized that the order of my object definitions
//mattered when attempting to link their values to one another. I had to shift the terah.children
//object to the top of my solution code so that those values were defined first and then flowed logically with
//the remaining objects.
//
// How difficult was it to add and delete properties outside of the object itself?
//No, not at all. I had to do a quick second of research, but it's really quite simple.
//
// What did you learn about manipulating objects in this challenge?
//I learned that the order of objects mattters when their values are linked together through object literal notation.
//Also, I found it straightfoward for adding and subtracting properties and values to JavaScript objects.
// __________________________________________
